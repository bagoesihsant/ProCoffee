                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control" value="<?= $user['username']; ?>" disabled></input>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <textarea class="form-control" rows="3" name="alamat" id="alamat"><?= $user['alamat'] ?></textarea>
                                        <?= form_error('about', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Joined Date </label> <i class="badge badge-success"><?= date('d F Y', $user['created_at']); ?></i>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="form-group text-center" style="position: relative;">
                            <span class="img-div">
                                ...
                                <div>
                                    <img src="<?= base_url(); ?>assets/user_img/<?= $user['profile_img']; ?>" onClick="triggerClick()" id="profileDisplay" width="200px">
                                </div>
                            </span>
