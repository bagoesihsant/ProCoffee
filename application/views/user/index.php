                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label><i class="far fa-calendar-alt mr-1"></i> Joined Date </label> <i class="badge badge-success"><?= date('d F Y', $user['created_at']); ?></i>
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid" src="<?= base_url() . 'assets/user_img/' . $user['profile_img']; ?>" alt="User profile picture">
                            </div>
                            ...
                            <ul class="list-group mb-3">
                                <li class="list-group-item">
                                    <b>Status</b> <a class="float-right"> <?php if ($user['kode_role'] == "RL0000000001") {
                                                                                echo "Administrator";
                                                                            } else {
                                                                                echo "Member";
                                                                            }  ?></a>
                            ...
                            <div class="text-center"><?php if ($user['active_status'] == 1) {
